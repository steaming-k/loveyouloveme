      ...
      <div className="flex flex-col gap-5">
        ...
        {cloud ? (
          <Section title="기기와 계정에 저장되는 것">
            ...
            내 답변·상대 정보·적어둔 장면·저장한 관찰 기록이 클라우드(계정 저장소)에도 저장돼. 사진은
            올리지 않아.
          </Section>
        ) : (
        ...
        <Section title="AI 분석 (실제 모드일 때만)">
          선택한 사진과, 관계 사건으로 적은 내용 일부를 포함한 답변이 관찰·설명을 만들기 위해 AI
          Provider로 전송될 수 있어. 사건은 전부가 아니라 해석에 필요한 몇 개만 짧게 잘라서 보내.
