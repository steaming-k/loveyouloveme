...
export const AXIS_DEFINITIONS: readonly AxisDefinition[] = [
  {
    ...
    evidence: '개인 시간 질문 답변과 상대에 대한 입력이 같은 구간이야.',
    scene: '각자 시간을 보내는 걸 거절로 받아들일 가능성이 비교적 낮아 보여.',
  },
  {
    key: 'affection',
    label: '애정 표현',
    theirsPhrase: { l: '담백', m: '보통', h: '표현 많음' },
    evidence: '애정 표현 질문 답변과 상대 입력이 같은 구간이야.',
    scene: '표현의 양 때문에 서운함이 생길 가능성은 낮은 편이야.',
  },
  {
    key: 'conflict',
    label: '갈등 해결',
    theirsPhrase: { l: '혼자 생각한 뒤 이야기', m: '조금 뒤 대화', h: '바로 대화' },
    evidence: '너는 갈등 질문에서 빠른 대화를 선택했고, 상대는 시간을 두는 쪽으로 입력됐어.',
    scene: '한쪽은 대화를 피한다고 느끼고, 다른 쪽은 생각할 시간을 주지 않는다고 느낄 수 있어.',
  },
  {
    key: 'contact',
    label: '연락 방식',
    theirsPhrase: { l: '뜸한 편', m: '보통', h: '자주' },
    evidence: '연락 중요도는 낮게 답했지만, 이전 관계에서는 연락 감소를 주요 어려움으로 선택했어.',
    scene: '연락 빈도가 달라지는 시기에 서로 다른 의미로 읽을 수 있어.',
  },
];
