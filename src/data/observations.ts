...
export const OBSERVED_TRAITS: readonly ObservedTrait[] = [
  {
    ...
    text: '영화 보는 걸 좋아함',
    confidence: 'high',
    evidence: '영화관·상영 시간표가 담긴 사진이 반복적으로 관찰됐어요.',
  },
  {
    id: 'ob2',
    text: '혼자 보내는 시간도 즐김',
    confidence: 'high',
    evidence: '카페·책상처럼 혼자 있는 장면이 여러 장에서 나왔어요.',
  },
  {
    id: 'ob3',
    text: '소수의 사람과 깊게 만나는 편',
    confidence: 'low',
    evidence: '사진에 등장하는 인물 수가 적었어요. 다만 사진만으로는 확신하기 어려워요.',
  },
  {
    id: 'ob4',
    text: '주말 외부 활동이 많은 편',
    confidence: 'medium',
    evidence: '산책·등산처럼 밖에서 찍은 사진이 절반 이상이었어요.',
  },
] as const;
